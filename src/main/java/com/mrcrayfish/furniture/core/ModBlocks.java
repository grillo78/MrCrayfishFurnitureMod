...
public class ModBlocks
{
    ...
    public static final Block PHOTO_FRAME = register(Names.Block.PHOTO_FRAME, new PhotoFrameBlock(Block.Properties.from(Blocks.IRON_BLOCK)), block -> new BlockSupplierItem(new Item.Properties().group(FurnitureMod.GROUP), block, () -> ModBlocks.PHOTO_FRAME));
